  ...
  valid = false;
    ...
    if (formData.profilePic) {
      try {
        ...
        if (formData.profilePic.includes('javascript:') || 
          ...
          {isEditMode ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.firstName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'}`}
                  required
                  maxLength={50}
                />
                {errors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.lastName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'}`}
                  required
                  maxLength={50}
                />
                {errors.lastName && (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 bg-gray-100 cursor-not-allowed ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300'}`}
                  disabled
                />
                <p className="text-gray-500 text-sm mt-1">Contact support to change email</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.profilePic ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'}`}
                  placeholder="https://example.com/profile.jpg"
                />
                {errors.profilePic && (
                  <p className="text-red-500 text-sm mt-1">{errors.profilePic}</p>
                )}
                <p className="text-gray-500 text-xs mt-1">Leave blank to remove profile picture</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border rounded-lg bg-gray-100 cursor-not-allowed capitalize"
                  disabled
                />
              </div>
              ...
              <button
                type="submit"
                className={`w-full py-3 rounded-lg text-white font-medium transition-colors ${loading ? 'bg-purple-400' : 'bg-purple-600 hover:bg-purple-700'}`}
                disabled={loading}
              >
                {loading ? (
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">First Name</h3>
                <p className="text-lg font-medium text-gray-800 mt-1">{user.firstName}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Last Name</h3>
                <p className="text-lg font-medium text-gray-800 mt-1">{user.lastName}</p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-lg font-medium text-gray-800 mt-1 capitalize">{user.role || 'user'}</p>
              </div>
